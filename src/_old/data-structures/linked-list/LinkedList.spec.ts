...
describe("Linked List Node", () => {
  it("creates with empty ref", () => {
    const value = 55
    const next = null
    const node = new LinkedListNode<number>(value, next)
  ...
  it("creates with ref", () => {
    const nextNode = new LinkedListNode<string | number>("string")
    const value = 155
    const node = new LinkedListNode<string | number>(value, nextNode)
