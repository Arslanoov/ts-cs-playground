import { BinarySearchTree, BinarySearchTreeNode } from "./BinarySearchTreePure"
 ...
 */
describe("BinarySearchTreeNode with Vanilla JS", () => {
...
describe("BinarySearchTree with vanilla JS", () => {
  it("should create binary search tree", () => {
