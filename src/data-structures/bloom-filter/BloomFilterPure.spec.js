import { BloomFilter, createStore } from "./BloomFilterPure"

/**
 * @see https://github.com/trekhleb/javascript-algorithms/blob/master/src/data-structures/bloom-filter/__test__/BloomFilter.test.js
 * TODO: Write my own tests
 */
describe("BloomFilter with Vanilla JS", () => {
  let bloomFilter
  const people = [
    "Bruce Wayne",
    "Clark Kent",
